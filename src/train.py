...
parser.add_argument('--batch_size', type = int, default = 15, help = 'training batch-size (default: 16)')
...
parser.add_argument('--epochs', type = int, default = 1, help = 'number of epochs (default: 20)')
