...
def create_model(model_name, device, num_labels=2, multitask=False, learnable_parameter=False):
    ...
    #bert_tokenizer = BertTokenizer.from_pretrained(bert_name)
        ...
        bert_model = BERT_based_classifier_multitask_alpha_parameter(basenet=model_name)
